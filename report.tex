...
\begin{center}
	\includegraphics[scale=0.5]{img/corrplot}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.65]{img/logit1}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.65]{img/lm1}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.65]{img/lmaic}
\end{center}
\hspace*{1cm} Under the BIC criterion, \texttt{stepwise} yielded:
\begin{center}
	\includegraphics[scale=0.65]{img/lmbic}
\end{center}
