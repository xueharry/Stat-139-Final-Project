...
\fancyfoot[L]{Christopher Chen, Josh Felizardo, Belino Xhafa, \& Wenzhe (Harry) Xue} % Empty left footer
...
\huge \textit{Mamba Out}: Analyzing Kobe Bryant's Shooting Performance \\ % The assignment title
...
\author{Christopher Chen, Josh Felizardo, Belino Xhafa, \& Wenzhe (Harry) Xue}
