...
overall_shot_perc = c(rep(1, sum(bydate_data$shots_made)), rep(0, sum(bydate_data$shots_taken)-sum(bydate_data$shots_made)))
overall_shot_perc_ci = boot.mean(x = overall_shot_perc, B = 1000)$interval
clutch_shot_perc = c(rep(1,sum(clutch_shots$clutch_shots_made)), rep(0,sum(clutch_shots$clutch_shots_taken)-sum(clutch_shots$clutch_shots_made)))
...
season11_shot_perc = c(rep(1, sum(bydate_data_season11$shots_made)), rep(0, sum(bydate_data_season11$shots_taken)-sum(bydate_data_season11$shots_made)))
season11_shot_perc_ci = boot.mean(x = season11_shot_perc, B = 1000)$interval
